...
hour_hand_shape = create_extended_hand_shape(clock_center, hour_angle_degrees, hour_hand_length, hour_hand_width,
                                             extend_length)
minute_angle_degrees = current_minute * 6 - 90
minute_hand_shape = create_extended_hand_shape(clock_center, minute_angle_degrees, minute_hand_length,
                                               minute_hand_width, extend_length)
